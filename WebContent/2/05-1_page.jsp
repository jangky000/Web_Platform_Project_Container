                            ...
                            <td width="80%">
                                <table border="1" width="600" height="700" align="center" valign="middle" rules="none">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td><p>&nbsp;신청 수량&nbsp;:&nbsp;<input type="text" size="20" maxlength="255" placeholder="3"> 개  <input type="submit" value="수정"> <a href=" 05_page.jsp" target="_self"><input type="submit" value="참여취소"></a>&nbsp;&nbsp;</p></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
