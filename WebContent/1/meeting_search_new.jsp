...
<body>
	...
	<form>
		<fieldset align="right">
			<br><div  align="left">
				제목&nbsp;<input type="text" name="title" size="90%" placeholder="제목을 입력해주세요"/></div>
			<br><br>
			...
			<fieldset align="left">
				...
				&nbsp;마감일자 :&nbsp;<input type="date" name="date"><br><br>
			...
			<div align="left">
			<textarea name="text" cols="150" rows="20" placeholder="소개글을 입력해주세요"></textarea></div><br><br>

			<div align="right">
				<input type="button" value="목록으로"  onclick = "location.href = 'meeting_search.jsp' "/>&nbsp;
				<input type="button" value="등록"  onclick = "location.href = 'meeting_search.jsp' "/>
			</div>
		</fieldset>
	</form>
</body>
