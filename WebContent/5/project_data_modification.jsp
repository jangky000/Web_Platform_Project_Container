...
<html>
    <head>
        <title>project_data modification page</title>
  ...
  <div>
      <table align="center" width="98%">
          <tr>
              ...
              <td align="right"><form action="project_modification.jsp"><input type="submit" value="수정"></form></td>
          </tr>
          <tr>
...
%>                    
      ...
      <div>
          <table  width="98%" align="center">
              <tr>
                  ...
                  <th align="right"><a href="project_summary_modification.jsp?seq=<%= seq %>"><input type="button" value="수정"></a></th>
              </tr>
              <tr>
                  <td colspan="2">
                      <ul>
  ...
  <div>
      <table  width="98%" align="center">
          <tr>
              <th align="right"><input type="hidden" value="저장"></th>
          </tr>
      </table>
      ...
      <blockquote>
          <table border="1"  width="90%" height="200" align="left">
              ...
              <tr>
              <form action="data_upload.jsp" method="POST" enctype="Multipart/form-data" target='hidden'>
                  <td> <input type = "file" name="fname"></td>
                  <td> <input type='hidden' name='seq' value='<%= seq %>'><input type='hidden' name='id' value='<%= sess %>'><input type = "text" name="memo" size = "60%"></td>
                  <td> <input type = "text" name="date" size = "40%">&nbsp;<input type="submit" value="추가"></td>
              </form>
              </tr>
...
//프로젝트 데이터
	seq = (String)request.getParameter("seq");
	sql="SELECT pd_seq, pd_file, pd_note, pd_date FROM project_data WHERE pj_seq=" + seq;
	stmt.executeQuery(sql);
	...
	if(rs.next()){
		do{
			out.print("<tr>");
			out.print("<td><form action='data_upload.jsp'><input type='hidden' name='id' value='" + sess + "'><input type='hidden' name='seq' value=" + seq + "><input type='hidden' name='pdseq' value=" + rs.getString("pd_seq") + "><input type='submit' value='삭제'>" + rs.getString("pd_file") + "</form></td>");
