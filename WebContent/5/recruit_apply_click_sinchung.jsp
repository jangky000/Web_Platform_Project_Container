      ...
      %>
        ...
        <div>
            ...
            <%
                   ...
                   sql = "select us_name, us_student_id, dp_name from user a join department b on a.dp_seq = b.dp_seq where a.us_id ='"+ id +"'"; 
            ...
            <form action = "apply_insert.jsp" target='hidden'>
                <div>
                <table border="0" width="60%">
                	<tr>
                		<td align="right"><input type="submit" value="등록">&nbsp;<input type="reset" value="초기화"></td>
                	</tr>
                </table>
                <table border = "2">
                                   <tr>
                    ...
                    <td><input type ="text" size = "100%" name = "profile"></td>
                    </tr>
