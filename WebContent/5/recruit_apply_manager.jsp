            ...
            <div>
                <table  width="98%" align="center">
                    <tr>
                        ...
                        <th align="right"><form><input type="submit" value="수정"></form></th>
                    </tr>
                ...
                <div>
                  <table>
                    <tr>
                      ...
                      <td>김oo / 멀티미디어공학과 / 4학년 <input type ="checkbox" name = "accept"></td>

                    </tr>

                    <tr>
                      <td><input type="image" src="paper.jpg" ></td>
                      <td>박oo / 정보통신공학과 / 3학년 <input type ="checkbox" name = "accept"> </td>

                    </tr>

                    <tr>
                      <td><input type="image" src="paper.jpg" ></td>
                      <td>이oo / 컴퓨터공학과 / 4학년 <input type ="checkbox" name = "accept"> </td>
                ...
                <div>
                    <table  width="98%" align="center">
                        <tr>
                            ...
                            <th align="right"><form><input type="submit" value="모집완료"></form></th>
                        </tr>
